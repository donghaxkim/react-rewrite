...
`).filter(n=>!n.match(El)),t).map(n=>{let o=n;if(o.includes(" > eval")&&(o=o.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g,":$1")),!o.includes("@")&&!o.includes(":"))return{functionName:o};{let r=/(([^\n\r"\u2028\u2029]*".[^\n\r"\u2028\u2029]*"[^\n\r@\u2028\u2029]*(?:@[^\n\r"\u2028\u2029]*"[^\n\r@\u2028\u2029]*)*(?:[\n\r\u2028\u2029][^@]*)?)?[^@]*)@/,i=o.match(r),a=i&&i[1]?i[1]:void 0,s=Ki(o.replace(r,""));return{functionName:a,fileName:s[0],lineNumber:s[1]?+s[1]:void 0,columnNumber:s[2]?+s[2]:void 0,source:o}}}),Tl=44,Fi="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",wl=new Uint8Array(64),Zi=new Uint8Array(128);for(let e=0;e<Fi.length;e++){let t=Fi.charCodeAt(e);wl[e]=t,Zi[t]=e}Sl=class{constructor(e){this.pos=0,this.buffer=e}next(){return this.buffer.charCodeAt(this.pos++)}peek(){return this.buffer.charCodeAt(this.pos)}indexOf(e){let{buffer:t,pos:n}=this,o=t.indexOf(e,n);return o===-1?t.length:o}};Ji=/^[a-zA-Z][a-zA-Z\d+\-.]*:/,Nl=/^data:application\/json[^,]+base64,/,kl=/(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^*]+?)[ \t]*(?:\*\/)[ \t]*$)/,Qi=typeof WeakRef<"u",Qt=new Map,Hn=new Map,Rl=e=>Qi&&e instanceof WeakRef,zi=(e,t,n,o)=>{if(n<0||n>=e.length)return null;let r=e[n];if(!r||r.length===0)return null;let i=null;for(let d of r)if(d[0]<=o)i=d;else break;if(!i||i.length<4)return null;let[,a,s,c]=i;if(a===void 0||s===void 0||c===void 0)return null;let u=t[a];return u?{columnNumber:c,fileName:u,lineNumber:s+1}:null},Pl=(e,t,n)=>{if(e.sections){let o=null;for(let a of e.sections)if(t>a.offset.line||t===a.offset.line&&n>=a.offset.column)o=a;else break;if(!o)return null;let r=t-o.offset.line,i=t===o.offset.line?n-o.offset.column:n;return zi(o.map.mappings,o.map.sources,r,i)}return zi(e.mappings,e.sources,t-1,n)},Al=(e,t)=>{let n=t.split(`
`),o;for(let i=n.length-1;i>=0&&!o;i--){let a=n[i].match(kl);a&&(o=a[1]||a[2])}if(!o)return null;let r=Ji.test(o);if(!(Nl.test(o)||r||o.startsWith("/"))){let i=e.split("/");i[i.length-1]=o,o=i.join("/")}return o},Ol=e=>({file:e.file,mappings:qi(e.mappings),names:e.names,sourceRoot:e.sourceRoot,sources:e.sources,sourcesContent:e.sourcesContent,version:3}),$l=e=>{let t=e.sections.map(({map:o,offset:r})=>({map:{...o,mappings:qi(o.mappings)},offset:r})),n=new Set;for(let o of t)for(let r of o.map.sources)n.add(r);return{file:e.file,mappings:[],names:[],sections:t,sourceRoot:void 0,sources:Array.from(n),sourcesContent:void 0,version:3}},Bi=e=>{if(!e)return!1;let t=e.trim();if(!t)return!1;let n=t.match(Ji);if(!n)return!0;let o=n[0].toLowerCase();return o==="http:"||o==="https:"},Hl=async(e,t=fetch)=>{if(!Bi(e))return null;let n;try{let r=await t(e);if(!r.ok)return null;n=await r.text()}catch{return null}if(!n)return null;let o=Al(e,n);if(!o||!Bi(o))return null;try{let r=await t(o);if(!r.ok)return null;let i=await r.json();return"sections"in i?$l(i):Ol(i)}catch{return null}},Il=async(e,t=!0,n)=>{if(t&&Qt.has(e)){let i=Qt.get(e);if(i==null)return null;if(Rl(i)){let a=i.deref();if(a)return a;Qt.delete(e)}else return i}if(t&&Hn.has(e))return Hn.get(e);let o=Hl(e,n);t&&Hn.set(e,o);let r=await o;return t&&Hn.delete(e),t&&(r===null?Qt.set(e,null):Qt.set(e,Qi?new WeakRef(r):r)),r},_l=async(e,t=!0,n)=>await Promise.all(e.map(async o=>{if(!o.fileName)return o;let r=await Il(o.fileName,t,n);if(!r||typeof o.lineNumber!="number"||typeof o.columnNumber!="number")return o;let i=Pl(r,o.lineNumber,o.columnNumber);return i?{...o,source:i.fileName&&o.source?o.source.replace(o.fileName,i.fileName):o.source,fileName:i.fileName,lineNumber:i.lineNumber,columnNumber:i.columnNumber,isSymbolicated:!0}:o})),Dl=e=>e._debugStack instanceof Error&&typeof e._debugStack?.stack=="string",Fl=()=>{let e=Ct();for(let t of[...Array.from(Xe),...Array.from(e.renderers.values())]){let n=t.currentDispatcherRef;if(n&&typeof n=="object")return"H"in n?n.H:n.current}return null},Wi=e=>{for(let t of Xe){let n=t.currentDispatcherRef;n&&typeof n=="object"&&("H"in n?n.H=e:n.current=e)}},_e=e=>`
    in ${e}`,Vl=(e,t)=>{let n=_e(e);return t&&(n+=` (at ${t})`),n},ur=!1,pr=(e,t)=>{if(!e||ur)return"";let n=Error.prepareStackTrace;Error.prepareStackTrace=void 0,ur=!0;let o=Fl();Wi(null);let r=console.error,i=console.warn;console.error=()=>{},console.warn=()=>{};try{let s={DetermineComponentFrameRoot(){let d;try{if(t){let p=function(){throw Error()};if(Object.defineProperty(p.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(p,[])}catch(m){d=m}Reflect.construct(e,[],p)}else{try{p.call()}catch(m){d=m}e.call(p.prototype)}}else{try{throw Error()}catch(m){d=m}let p=e();p&&typeof p.catch=="function"&&p.catch(()=>{})}}catch(p){if(p instanceof Error&&d instanceof Error&&typeof p.stack=="string")return[p.stack,d.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot",Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name")?.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});let[c,u]=s.DetermineComponentFrameRoot();if(c&&u){let d=c.split(`
`),p=u.split(`
...
${d[m].replace(" at new "," at ")}`,y=le(e);return y&&g.includes("<anonymous>")&&(g=g.replace("<anonymous>",y)),g}while(m>=1&&f>=0);break}}}finally{ur=!1,Error.prepareStackTrace=n,Wi(o),console.error=r,console.warn=i}let a=e?le(e):"";return a?_e(a):""},zl=(e,t)=>{let n=e.tag,o="";switch(n){case nr:o=_e("Activity");break;case Uo:o=pr(e.type,!0);break;case Ko:o=pr(e.type.render,!1);break;case Go:case qo:o=pr(e.type,!1);break;case Xo:case er:case tr:o=_e(e.type);break;case Jo:o=_e("Lazy");break;case Zo:o=e.child!==t&&t!==null?_e("Suspense Fallback"):_e("Suspense");break;case Qo:o=_e("SuspenseList");break;case or:o=_e("ViewTransition");break;default:return""}return o},Bl=e=>{try{let t="",n=e,o=null;do{t+=zl(n,o);let r=n._debugInfo;if(r&&Array.isArray(r))for(let i=r.length-1;i>=0;i--){let a=r[i];typeof a.name=="string"&&(t+=Vl(a.name,a.env))}o=n,n=n.return}while(n);return t}catch(t){return t instanceof Error?`
...
`,o)),o!==-1)n=n.slice(0,o);else return"";return n},Yl=e=>!!(e.fileName?.startsWith("rsc://")&&e.functionName),jl=(e,t)=>e.fileName===t.fileName&&e.lineNumber===t.lineNumber&&e.columnNumber===t.columnNumber,Gl=e=>{let t=new Map;for(let n of e)for(let o of n.stackFrames){if(!Yl(o))continue;let r=o.functionName,i=t.get(r)??[];i.some(a=>jl(a,o))||(i.push(o),t.set(r,i))}return t},Ul=(e,t,n)=>{if(!e.functionName)return{...e,isServer:!0};let o=t.get(e.functionName);if(!o||o.length===0)return{...e,isServer:!0};let r=n.get(e.functionName)??0,i=o[r%o.length];return n.set(e.functionName,r+1),{...e,isServer:!0,fileName:i.fileName,lineNumber:i.lineNumber,columnNumber:i.columnNumber,source:e.source?.replace(Gi,`(${i.fileName}:${i.lineNumber}:${i.columnNumber})`)}},Xl=e=>{let t=[];return rr(e,n=>{if(!Dl(n))return;let o=typeof n.type=="string"?n.type:le(n.type)||"<anonymous>";t.push({componentName:o,stackFrames:Xi(Wl(n._debugStack?.stack))})},!0),t},Re=async(e,t=!0,n)=>{let o=Xl(e),r=Xi(Bl(e)),i=Gl(o),a=new Map;return _l(r.map(s=>s.source?.includes(Gi)??!1?Ul(s,i,a):s).filter((s,c,u)=>{if(c===0)return!0;let d=u[c-1];return s.functionName!==d.functionName}),t,n)},Yi=e=>e.split("/").filter(Boolean).length,Kl=e=>e.split("/").filter(Boolean)[0]??null,Zl=e=>{let t=e.indexOf("/",1);if(t===-1||Yi(e.slice(0,t))!==1)return e;let n=e.slice(t);if(!ji.test(n)||Yi(n)<2)return e;let o=Kl(n);return!o||o.startsWith("@")||o.length>4?e:n},Le=e=>{if(!e||yl.some(i=>i===e))return"";let t=e,n=t.startsWith("http://")||t.startsWith("https://");if(n)try{t=new URL(t).pathname}catch{}if(n&&(t=Zl(t)),t.startsWith("about://React/")){let i=t.slice(14),a=i.indexOf("/"),s=i.indexOf(":");t=a!==-1&&(s===-1||a<s)?i.slice(a+1):i}let o=!0;for(;o;){o=!1;for(let i of bl)if(t.startsWith(i)){t=t.slice(i.length),i==="file:///"&&(t=`/${t.replace(/^\/+/,"")}`),o=!0;break}}if(Ii.test(t)){let i=t.match(Ii);i&&(t=t.slice(i[0].length))}if(t.startsWith("//")){let i=t.indexOf("/",2);t=i===-1?"":t.slice(i)}let r=t.indexOf("?");if(r!==-1){let i=t.slice(r);xl.test(i)&&(t=t.slice(0,r))}return t},Pe=e=>{let t=Le(e);return!(!t||!ji.test(t)||vl.test(t))}});function De(e){return!!(ql.has(e)||e.startsWith("_")||e.startsWith("$")||e.includes("Provider")||e.includes("Context")||e==="Head"||e==="html"||e==="body")}function fr(e){let t=e.tagName.toLowerCase();if(t==="html"||t==="body")return!0;let n=e.getBoundingClientRect(),o=window.innerWidth,r=window.innerHeight;return n.width>=o*.9&&n.height>=r*.9}function gr(){en=new WeakMap}function tc(e,t){return t.display!=="none"&&t.visibility!=="hidden"&&t.opacity!=="0"}function nc(e){let t=parseInt(e.zIndex,10);return e.pointerEvents==="none"&&e.position==="fixed"&&!isNaN(t)&&t>=Ql}function oc(e,t){let n=t.position;if(n!=="fixed"&&n!=="absolute")return!1;let o=e.getBoundingClientRect();if(o.width/window.innerWidth<In||o.height/window.innerHeight<In)return!1;let r=t.backgroundColor;if(r==="transparent"||r==="rgba(0, 0, 0, 0)"||parseFloat(t.opacity)<.1)return!0;let i=parseInt(t.zIndex,10);return!isNaN(i)&&i>ec}function tn(e){let t=e instanceof HTMLElement?e.tagName.toLowerCase():"";if(t==="html"||t==="body"||e instanceof HTMLElement&&fr(e)||e.closest("#frameup-root")||e instanceof HTMLElement&&e.hasAttribute("data-frameup-interaction")||e instanceof HTMLElement&&e.hasAttribute("data-frameup-placeholder"))return!1;let n=performance.now(),o=en.get(e);if(o&&n-o.timestamp<Jl)return o.isValid;let r=window.getComputedStyle(e);return tc(e,r)?e.clientWidth/window.innerWidth>=In&&e.clientHeight/window.innerHeight>=In&&(nc(r)||oc(e,r))?(en.set(e,{isValid:!1,timestamp:n}),!1):(en.set(e,{isValid:!0,timestamp:n}),!0):(en.set(e,{isValid:!1,timestamp:n}),!1)}var ql,Jl,In,Ql,ec,en,it=ve(()=>{"use strict";ql=new Set(["InnerLayoutRouter","OuterLayoutRouter","RedirectErrorBoundary","RedirectBoundary","HTTPAccessFallbackErrorBoundary","HTTPAccessFallbackBoundary","LoadingBoundary","ErrorBoundary","ScrollAndFocusHandler","InnerScrollAndFocusHandler","RenderFromTemplateContext","DevRootHTTPAccessFallbackBoundary","AppDevOverlayErrorBoundary","AppDevOverlay","HotReload","Router","ErrorBoundaryHandler","AppRouter","ServerRoot","SegmentStateProvider","RootErrorBoundary","Suspense","Fragment","StrictMode","ReplaySsrOnlyErrors","SegmentViewNode","SegmentTrieNode"]);Jl=50,In=.9,Ql=2147483600,ec=1e3,en=new WeakMap});function $c(e,t,n){let o=n&&n!=="none"?` ${n}`:"";return`translate(${e}px, ${t}px)${o}`}function st(e){e.element.style.transform=$c(e.delta.dx,e.delta.dy,e.existingTransform)}function La(e){e.existingTransform&&e.existingTransform!=="none"?e.element.style.transform=e.existingTransform:e.element.style.transform=""}function kt(e,t,n,o){e.style.transform=`translate(${t}px, ${n}px) scale(1.02)${o&&o!=="none"?` ${o}`:""}`,e.style.boxShadow=R.lg,e.style.transition="none",e.style.zIndex="2147483644"}function Na(e){st(e),e.element.style.boxShadow="",e.element.style.transition="",e.element.style.zIndex=""}function Yn(e){let t=document.querySelectorAll(e.tagName);for(let n of t)if(n instanceof HTMLElement)try{let o=oe(n);for(;o;){if(ge(o)){let r=o._debugSource,i=le(o);if(r&&i===e.componentName&&r.fileName?.endsWith(e.filePath)&&r.lineNumber===e.lineNumber)return n}o=o.return}}catch{}return null}async function ka(e){let t=document.querySelectorAll(e.tagName);for(let n of t)if(n instanceof HTMLElement)try{let o=oe(n);if(!o)continue;let r=await Re(o);if(!r||r.length===0)continue;for(let i of r)if(!(!i.functionName||i.functionName!==e.componentName)&&i.fileName){let a=Le(i.fileName);if(Pe(a)&&a.endsWith(e.filePath))return n}}catch{}return null}var jn=ve(()=>{"use strict";rt();Et();j()});function Pa(e){return Gn.push(e),()=>{Gn=Gn.filter(t=>t!==e)}}function Aa(e){return Un.push(e),()=>{Un=Un.filter(t=>t!==e)}}function lt(){Un.forEach(e=>e())}function Zn(){return Nr}function Rr(e){let t=Nr;t!==e&&(Nr=e,Gn.forEach(n=>n(e,t)))}function Te(){return{...Ra}}function cn(e,t){Ra[e]=t}function Oa(){return Ee}function $a(e){Ee.set(e.id,e),Jn({type:"moveCreate",moveId:e.id})}function Ha(e,t,n){let o=Ee.get(e);o&&(o.delta=t,st(o),Jn({type:"moveDelta",moveId:e,previousDelta:n}))}function Pr(e){let t=Ee.get(e);t&&(t.element.style.cssText=t.originalCssText,t.placeholder&&t.placeholder.parentNode&&t.placeholder.parentNode.removeChild(t.placeholder),Ee.delete(e),lt())}function qn(e){if(Ve.push(e),e.type==="colorChange"){let t=e;qe.push({type:"colorChange",annotationId:e.id,property:t.property,previousColor:t.fromColor})}else qe.push({type:"annotationAdd",annotationId:e.id});lt()}function Ar(e,t,n){Ve.push(e),qe.push({type:"textEditRestore",annotationId:e.id,elementIdentity:t,originalInnerHTML:n}),lt()}function _a(e){Ia=e}function Lr(e){Ve=Ve.filter(t=>t.id!==e),Ia?.(e),lt()}function Da(){return kr}function Fa(e){kr=e;for(let t of Ee.values())e?st(t):La(t);lt()}function Or(e){for(let t of Ee.values())if(t.element===e)return t}function $r(){let e=qe.pop();if(!e)return null;switch(e.type){case"moveCreate":return Pr(e.moveId),"move removed";case"moveDelta":{let t=Ee.get(e.moveId);return t&&(t.delta=e.previousDelta,st(t)),"move reverted"}case"annotationAdd":return Lr(e.annotationId),"annotation removed";case"colorChange":{let t=Ve.find(n=>n.id===e.annotationId);return t?.targetElement&&(t.targetElement.style[e.property]=e.previousColor),Lr(e.annotationId),"color reverted"}case"propertyChange":{let t=e;if(t.element&&document.contains(t.element))for(let n of t.overrides)t.element.style[n.cssProperty]=n.previousValue;return"property reverted"}case"textEditRestore":{let t=Yn(e.elementIdentity);return t&&(t.innerHTML=e.originalInnerHTML),Lr(e.annotationId),"text edit reverted"}}return null}function Jn(e){qe.push(e),lt()}function ze(){return{scale:ln,offsetX:Xn,offsetY:Kn}}function Qn(e,t,n){ln=e,Xn=t,Kn=n,sn.forEach(o=>o())}function eo(e){return sn.push(e),()=>{sn=sn.filter(t=>t!==e)}}function Je(e,t){return{x:(e-Xn)/ln,y:(t-Kn)/ln}}function to(){for(let e of Ee.values())e.element.style.cssText=e.originalCssText,e.placeholder&&e.placeholder.parentNode&&e.placeholder.parentNode.removeChild(e.placeholder);for(let e of Ve)if(e.type==="colorChange"){let t=e;t.targetElement&&(t.targetElement.style[t.property]=t.fromColor)}for(let e of qe)if(e.type==="propertyChange"){let t=e;if(t.element&&document.contains(t.element))for(let n of t.overrides)t.element.style[n.cssProperty]=n.previousValue}Ee=new Map,Ve=[],qe=[],kr=!0,ln=1,Xn=0,Kn=0,sn.forEach(e=>e()),lt()}function no(){return Ee.size>0||Ve.length>0}function Va(){return qe.length>0}function za(){let e=Array.from(Ee.values()).map(r=>({component:r.componentRef.componentName,file:r.componentRef.filePath,line:r.componentRef.lineNumber,originalRect:{top:r.originalRect.top,left:r.originalRect.left,width:r.originalRect.width,height:r.originalRect.height},delta:{dx:r.delta.dx,dy:r.delta.dy},siblingRects:(()=>{let i=r.element.parentElement;if(!i)return;let a=[];for(let s of Array.from(i.children)){if(s===r.element||!(s instanceof HTMLElement))continue;let c=s.getBoundingClientRect();a.push({component:s.tagName.toLowerCase(),rect:{top:c.top,left:c.left,width:c.width,height:c.height}})}return a.length>0?a:void 0})()})),t=[],n=[],o=[];for(let r of Ve)r.type==="draw"?t.push({type:"draw",startComponent:r.targetComponent?.componentName,startFile:r.targetComponent?.filePath,startLine:r.targetComponent?.lineNumber,points:r.points,color:r.color,strokeWidth:r.strokeWidth}):r.type==="text"?t.push({type:"text",content:r.content,position:r.position,targetComponent:r.targetComponent?.componentName,targetFile:r.targetComponent?.filePath,targetLine:r.targetComponent?.lineNumber}):r.type==="colorChange"?n.push({component:r.component.componentName,file:r.component.filePath,line:r.component.lineNumber,property:r.property,from:r.fromColor,to:r.toColor,pickedToken:r.pickedToken}):r.type==="textEdit"&&o.push({component:r.componentName,file:r.filePath,line:r.lineNumber,column:r.columnNumber,originalText:r.originalText,newText:r.newText});return{moves:e,annotations:t,colorChanges:n,textEdits:o}}var Ee,Ve,qe,Nr,kr,Ra,ln,Xn,Kn,sn,Gn,Un,Ia,we=ve(()=>{"use strict";jn();Ee=new Map,Ve=[],qe=[],Nr="pointer",kr=!0,Ra={brushSize:4,brushColor:"#ef4444",fontSize:16,textColor:"#ffffff"},ln=1,Xn=0,Kn=0,sn=[],Gn=[],Un=[];Ia=null});function ad(){jr=document.body.style.background||document.body.style.backgroundColor||"",Gr=document.documentElement.style.background||document.documentElement.style.backgroundColor||"";let e=getComputedStyle(document.body).backgroundColor,t=getComputedStyle(document.documentElement).backgroundColor,n=e&&e!=="rgba(0, 0, 0, 0)"?e:t&&t!=="rgba(0, 0, 0, 0)"?t:"#ffffff";document.body.style.background="transparent",document.documentElement.style.background="transparent",Z=document.createElement("div"),Z.setAttribute("data-frameup-canvas-wrapper","true"),Z.style.cssText=`
  ...
  `.trim().replace(/\n\s*/g," ");let o=Array.from(document.body.childNodes);for(let r of o)r instanceof HTMLElement&&(r.id==="frameup-root"||r.hasAttribute("data-frameup-interaction")||r.hasAttribute("data-frameup-placeholder")||r.hasAttribute("data-frameup-annotation")||r.hasAttribute("data-frameup-dot-bg")||r.hasAttribute("data-frameup-canvas-wrapper"))||(fs.push(r),Z.appendChild(r));Z.style.position="relative",Z.style.zIndex="1",document.body.insertBefore(ke,document.body.firstChild),document.body.insertBefore(Z,ke.nextSibling),Yr=eo(ms),ms(),gs.forEach(r=>r(Z))}function ms(){if(!Z||!ke)return;let{scale:e,offsetX:t,offsetY:n}=ze();Z.style.transform=`translate(${t}px, ${n}px) scale(${e})`;let o=rd*e,r=t%o,i=n%o;ke.style.backgroundImage=`radial-gradient(circle, ${id} ${ps}px, transparent ${ps}px)`,ke.style.backgroundSize=`${o}px ${o}px`,ke.style.backgroundPosition=`${r}px ${i}px`}function sd(e,t,n){let{scale:o,offsetX:r,offsetY:i}=ze(),a=Math.min(nd,Math.max(td,o+n));if(a===o)return;let s=(e-r)/o,c=(t-i)/o,u=e-s*a,d=t-c*a;Qn(a,u,d)}function hs(e){e.preventDefault();let t=-e.deltaY*od,{scale:n}=ze(),o=t*n;sd(e.clientX,e.clientY,o)}function bs(e,t){let{scale:n,offsetX:o,offsetY:r}=ze();Qn(n,o+e,r+t)}function ys(){Qn(1,0,0)}function vs(){return Z!==null}function xs(){Z?Ur():ad()}function Ur(){if(gs.forEach(e=>e(null)),Yr?.(),Yr=null,Z){for(;Z.firstChild;)document.body.insertBefore(Z.firstChild,Z);Z.remove(),Z=null}ke?.remove(),ke=null,fs=[],document.body.style.background=jr,document.documentElement.style.background=Gr,jr="",Gr=""}var td,nd,od,rd,ps,id,Z,ke,Yr,fs,gs,jr,Gr,hn=ve(()=>{"use strict";we();j();td=.1,nd=5,od=.002,rd=24,ps=1,id="rgba(0,0,0,0.15)",Z=null,ke=null,Yr=null,fs=[],gs=[],jr="",Gr=""});function Cs(e,t){if(!ut)return;let n=performance.now(),o=Math.abs(e-ut.clientX),r=Math.abs(t-ut.clientY),i=o<=2&&r<=2,a=n-ut.timestamp<16;if(i||a)return ut.element}function Es(e,t,n){ut={clientX:e,clientY:t,element:n,timestamp:performance.now()}}function Dt(){ut=null}var ut,Xr=ve(()=>{"use strict";ut=null});var ws={};al(ws,{activateInteraction:()=>yn,destroyInteraction:()=>Jr,getPageElementAtPoint:()=>pt,initInteraction:()=>Zr,refreshDrawCursor:()=>cd,registerToolHandler:()=>Ft,setInteractionCursor:()=>vo,setInteractionPointerEvents:()=>qr});function Ft(e,t){Kr.set(e,t)}function Zr(){I=document.createElement("div"),I.setAttribute("data-frameup-interaction","true"),I.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
...
`;function Mi(e){let t=document.createElement("div");t.id="frameup-root",document.body.appendChild(t),xt=t.attachShadow({mode:"open"});let n=document.createElement("style");n.textContent=fl;let o=document.createElement("div");o.className="toolbar",o.innerHTML=`
  ...
  `.trim().replace(/\n\s*/g," "),d.textContent="content";let p=[];function m(S){let w=document.createElement("span"),fe=r.get(S.key)??S.defaultValue;return w.textContent=H(fe),w.title=S.label,w.style.cssText=`
    ...
    align-items:center;
    gap:2px;
  `.trim().replace(/\n\s*/g," ");let b=E("margin","top");b.style.gridRow="1",b.style.gridColumn="2",b.style.textAlign="center";let T=E("margin","left");T.style.gridRow="2",T.style.gridColumn="1";let _=E("margin","right");_.style.gridRow="2",_.style.gridColumn="3";let J=E("margin","bottom");J.style.gridRow="3",J.style.gridColumn="2",J.style.textAlign="center";let Q=document.createElement("div");Q.style.cssText="grid-row:2; grid-column:2;",Q.appendChild(u),Y.appendChild(b),Y.appendChild(T),Y.appendChild(Q),Y.appendChild(_),Y.appendChild(J);let Tn=A("margin"),rl=A("padding"),wn=document.createElement("div");return wn.style.cssText="display:flex; gap:8px; padding:0 4px;",wn.appendChild(Tn),wn.appendChild(rl),c.appendChild(Y),s.appendChild(c),a.appendChild(wn),a.appendChild(s),{element:a,setValue(S,w){if(!va(S))return;r.set(S,w);let ne=p.find(nt=>nt.key===S);ne&&(ne.span.textContent=H(w))},destroy(){}}}j();var Bn=new Set;function Ca(e){return Bn.has(e)}var Wn=[];function Ea(e){return Wn.push(e),()=>{let t=Wn.indexOf(e);t>=0&&Wn.splice(t,1)}}var Cc={layout:"Layout",spacing:"Spacing",size:"Size",typography:"Typography",background:"Background"},Ec={"number-scrub":ha,segmented:ba,"color-swatch":ya,"box-model":xa},Tc=`
  .prop-section {
...
`,It=null;function os(){let e=X();if(!e)return;let t=document.createElement("style");t.textContent=qc,e.appendChild(t),Za({onStart:Jc,onMove:Qc,onEnd:ed}),He(n=>{n.type==="reorderComplete"&&(zr(),je())})}function Jc(e,t,n){et=n,ns=t,Ht={x:e.clientX,y:e.clientY},gn=!1,bo=!1,go=[],ho=new Map,It=null;let o=X();if(!o)return;me=document.createElement("div"),me.className="drag-preview";let r=t.getBoundingClientRect();me.style.width=`${r.width}px`,me.style.height=`${r.height}px`,me.innerHTML=t.outerHTML,o.appendChild(me),pe=document.createElement("div"),pe.className="drop-indicator",o.appendChild(pe);let i=n.stack[1];if(!i)return;xe({type:"getSiblings",filePath:i.filePath,parentLine:i.lineNumber});let a=He(s=>{if(s.type!=="siblingsList")return;a(),go=s.siblings;let c=document.querySelectorAll("*");for(let u of c){if(u.closest("#frameup-root"))continue;let d=oe(u);if(!d)continue;let p=d;for(;p;){if(ge(p)){let m=p._debugSource||p._debugOwner?._debugSource;if(m){for(let f of s.siblings)m.lineNumber===f.lineNumber&&m.fileName===i.filePath&&ho.set(f.lineNumber,{el:u,rect:u.getBoundingClientRect()});break}}p=p.return}}bo=!0})}function Qc(e){if(!Ht)return;let t=Math.abs(e.clientX-Ht.x),n=Math.abs(e.clientY-Ht.y);if(t<5&&n<5||(gn=!0,me&&(me.style.display="block",me.style.left=`${e.clientX+10}px`,me.style.top=`${e.clientY+10}px`),!bo||!et))return;let o=null,r=1/0,i=0,a=0,s=0;for(let c of go){if(c.lineNumber===et.lineNumber)continue;let u=ho.get(c.lineNumber);if(!u)continue;let d=u.rect,p=d.top+d.height/2,m=Math.abs(e.clientY-p);m<r&&(r=m,o=c,e.clientY<p?i=d.top-2:i=d.bottom+2,a=d.left,s=d.width)}It=o,o&&pe?(pe.style.display="block",pe.style.top=`${i}px`,pe.style.left=`${a}px`,pe.style.width=`${s}px`):pe&&(pe.style.display="none")}function ed(e){if(!gn||!It||!et){zr();return}xe({type:"reorder",filePath:et.filePath,fromLine:et.lineNumber,toLine:It.lineNumber,fromComponent:et.componentName,toComponent:It.componentName}),me&&(me.style.display="none"),pe&&(pe.style.display="none"),gn=!1,Ht=null}function zr(){me?.remove(),pe?.remove(),me=null,pe=null,et=null,ns=null,gn=!1,Ht=null,bo=!1,go=[],ho=new Map,It=null}function rs(){zr()}j();we();var dt="http://www.w3.org/2000/svg",_t=null,ie=null,Br=null;function is(){let e=X();e&&(_t=document.createElementNS(dt,"svg"),_t.setAttribute("style","position:fixed;top:0;left:0;width:100vw;height:100vh;pointer-events:none;z-index:2147483645;"),ie=document.createElementNS(dt,"g"),ie.setAttribute("class","annotation-root"),_t.appendChild(ie),e.appendChild(_t),window.addEventListener("scroll",yo,{passive:!0}),Br=eo(yo),yo())}function yo(){if(!ie)return;let{scale:e,offsetX:t,offsetY:n}=ze();ie.setAttribute("transform",`translate(${t}, ${n}) scale(${e})`)}function as(e,t,n,o){if(!ie||t.length<2)return null;let r=document.createElementNS(dt,"g");r.setAttribute("data-annotation-id",e);let i=document.createElementNS(dt,"path");return i.setAttribute("d",ds(t)),i.setAttribute("stroke",n),i.setAttribute("stroke-width",String(o)),i.setAttribute("stroke-linecap","round"),i.setAttribute("stroke-linejoin","round"),i.setAttribute("fill","none"),r.appendChild(i),ie.appendChild(r),r}function ss(e,t,n,o,r,i){if(!ie)return null;let a=document.createElementNS(dt,"foreignObject");a.setAttribute("data-annotation-id",e),a.setAttribute("x",String(t)),a.setAttribute("y",String(n)),a.setAttribute("width","300"),a.setAttribute("height","100");let s=document.createElement("div");return s.style.cssText=`
    background: ${l.bgPrimary};
    color: ${l.textPrimary};
    border: 1px solid ${l.border};
    box-shadow: ${R.sm};
